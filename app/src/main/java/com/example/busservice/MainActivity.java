...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button BtnAir = (Button)findViewById(R.id.BtnAir);
        Button BtnFan = (Button)findViewById(R.id.BtnFan);
        BtnAir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this,GroupbusActivity.class);
                startActivity(i);
            }
        });
        BtnFan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ii = new Intent(MainActivity.this,Groupbus2Activity.class);
                startActivity(ii);
